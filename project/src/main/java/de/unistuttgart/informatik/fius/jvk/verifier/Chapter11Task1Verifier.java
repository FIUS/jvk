...
public class Chapter11Task1Verifier implements TaskVerifier {
    ...
    private BasicTaskInformation taskB = new BasicTaskInformation("b) Handle the Exception", "Avoid the Exception from Exercise 1");
    ...
    public Chapter11Task1Verifier() {
        ...
        this.task = new BasicTaskInformation("Chapter 11 Task 1", "What IF there is a Wall?", subTasks);
    }
