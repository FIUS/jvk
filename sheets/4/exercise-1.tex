...
\begin{enumerate}
    \item Passe die Main Operation an die Aufgabe an. Verwende \lstinline{VerwendeSheet4Task1}. Verifier brauchst du nicht setzen weil es in auf diesem Blatt keine gibt.
