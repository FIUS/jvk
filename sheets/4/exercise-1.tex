...
%
%        \subexcercise Implementiere die Operation \textit{checkSideWall()} der Klasse \textit{{MySmartNeo}.
...
%
%
%        \subexcercise Implementiere die Operation \textit{{moveSmart()} der Klasse \textit{{MySmartNeo}.
...
%
%
%        \subexcercise Die Klasse \textit{Solution4_2} enthält ein Attribut vom Typ SmartNeo.
