...
public void moveTwice() {
    ...
    \begin{itemize}
        ...
        \item \lstinline{void} (engl. \q{Leere}) bedeutet, dass die Operation keinen Rückgabewert hat.
    ...
    public String getGreeting() {
        ...
        \item Angenommen eine Münze ist \(2\) Taler wert. 
            ...
            \emph{Bemerkung:} Verwendet für diese Aufgabe den Typ \lstinline{int}. % TODO do not use nt (use Integer)
            Er ist der am häufigsten verwendete Typ für Ganzzahlen. 
            Wir schauen uns die verschiedenen Typen zu einem späteren Zeitpunkt noch genauer an.
        
            Es kann vorkommen, dass wir den Kommandos oder Abfragen, die wir ausführen, zusätzliche Informationen mitgeben wollen. 
            Hierzu können wir Werte an Operationen übergeben, die \emph{Argmente} heißen. 
            Diese schreiben wir in die Klammern hinter dem Operationsnamen. 
            Eine \footnote{zugegebenermaßen nicht allzu sinnvolle} Operation, die zwei Zahlen addiert, würde zum Beispiel so aussehen:
    ...
    public int add(final int a, final int b) {
        return a + b;
            ...
            Das \lstinline{final} hierbei bedeutet, dass wir den Wert des Arguments in der Operation nicht verändern können. % TODO it is probably better not to use final for code for students
